...
<section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Dinos Shop</h3>
        <div class="row">
                            ...
                            <div class="product-toys-info">
                                <div class="men-pro-item">
                                    <div class="men-thumb-item">
                                        <img src="/frontend/images/{{$product->images}}" class="img-thumbnail img-fluid" alt="">
                                            ...
                                            <div class="grid_meta">
                                                <div class="product_price">
                                                    ...
                                                    <div class="grid-price mt-2">
                                                        <span class="money ">{{$product->unit_price}}</span>
                                                    </div>
                                                </div>
                                                <ul class="stars">
                                                    <?php 
                                                        for($i=0; $i<$product->vote;$i++){
                                                            echo "<li>
                                                                 <a href=";
