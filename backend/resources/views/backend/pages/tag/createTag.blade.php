...
<div class="xs">
  ...
  <form method="POST" action="{{url('create-tag')}}"  class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" ng-submit="submit()">
    @csrf
    <fieldset>
